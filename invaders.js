...
function preload() {
    ...
    game.load.image('background', 'background2.png');
      this.game.load.audio('fxexplode', 'explosion.mp3');
        this.game.load.audio('fxlazer', 'lazer.wav');
...
function create() {
    ...
    fxexplode = this.game.add.audio('fxexplode');
    fxlazer = this.game.add.audio('fxlazer');
